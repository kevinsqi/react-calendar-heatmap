...
/***/ function(module, exports, __webpack_require__) {
	...
	var _dateHelpers = __webpack_require__(40);
	...
	var CalendarHeatmap = function (_React$Component) {
	  ...
	  function CalendarHeatmap(props) {
	    ...
	    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(CalendarHeatmap).call(this, props));
	  ...
	  _createClass(CalendarHeatmap, [{
	    ...
	    value: function getStartDate() {
	      return (0, _dateHelpers.shiftDate)(this.getEndDate(), -this.props.numDays + 1); // +1 because endDate is inclusive
	    }
	  }, {
	    key: 'getEndDate',
	    ...
	    value: function getValueCache(values) {
	      ...
	      return (0, _lodash4.default)(values, function (memo, value) {
	    ...
	    value: function renderSquare(dayIndex, index) {
	      ...
	      var _getSquareCoordinates2 = _slicedToArray(_getSquareCoordinates, 2);

	      var x = _getSquareCoordinates2[0];
	      var y = _getSquareCoordinates2[1];
	    ...
	    value: function renderAllWeeks() {
	      ...
	      return (0, _lodash2.default)(this.getWeekCount()).map(function (weekIndex) {
	    ...
	    value: function renderMonthLabels() {
	      ...
	      var weekRange = (0, _lodash2.default)(this.getWeekCount() - 1); // don't render for last week, because label will be cut off
	      return weekRange.map(function (weekIndex) {
	        ...
	        var _getMonthLabelCoordin = _this5.getMonthLabelCoordinates(weekIndex);

	        var _getMonthLabelCoordin2 = _slicedToArray(_getMonthLabelCoordin, 2);

	        var x = _getMonthLabelCoordin2[0];
	        var y = _getMonthLabelCoordin2[1];

	        return endOfWeek.getDate() >= 1 && endOfWeek.getDate() <= _constants.DAYS_IN_WEEK ? _react2.default.createElement(
	          'text',
	          {
	            key: weekIndex,
	            x: x,
	          ...
	          _constants.MONTH_LABELS[endOfWeek.getMonth()]
	        ) : null;
	      });
	    }
	  }, {
	...
	CalendarHeatmap.propTypes = {
	  values: _react.PropTypes.arrayOf( // array of objects with date and arbitrary metadata
	  ...
	  numDays: _react.PropTypes.number, // number of days back from endDate to show
	  endDate: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.number, _react.PropTypes.instanceOf(Date)]), // end of date range
	  gutterSize: _react.PropTypes.number, // size of space between squares
	  horizontal: _react.PropTypes.bool, // whether to orient horizontally or vertically
	  showMonthLabels: _react.PropTypes.bool, // whether to show month labels
	  showOutOfRangeDays: _react.PropTypes.bool, // whether to render squares for extra days in week after endDate, and before start date
	  tooltipDataAttrs: _react.PropTypes.object, // data attributes to add to square for setting 3rd party tooltips, e.g. { 'data-toggle': 'tooltip' } for bootstrap tooltips
	  titleForValue: _react.PropTypes.func, // function which returns title text for value
	  classForValue: _react.PropTypes.func, // function which returns html class for value
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Copyright Jeremy Ashkenas, DocumentCloud and Investigative Reporters & Editors
	 */
	var stringToPath = __webpack_require__(37);
...
/***/ function(module, exports) {
	...
	var MILLISECONDS_IN_ONE_DAY = exports.MILLISECONDS_IN_ONE_DAY = 24 * 60 * 60 * 1000;
	var DAYS_IN_WEEK = exports.DAYS_IN_WEEK = 7;
	var MONTH_LABELS = exports.MONTH_LABELS = {
	  0: 'Jan',
	  1: 'Feb',
	  2: 'Mar',
	  3: 'Apr',
...
/***/ function(module, exports) {
	...
	exports.getBeginningTimeForDate = getBeginningTimeForDate;
...
/***/ function(module, exports, __webpack_require__) {
	...
	console.log('react-calendar-heatmap v' + ("1.0.0"));
	...
	function generateRandomValues(count) {
	  var date = arguments.length <= 1 || arguments[1] === undefined ? today : arguments[1];

	  return (0, _lodash2.default)(count).map(function (index) {
	    return {
	      date: (0, _dateHelpers.shiftDate)(date, -index),
	...
	var customTooltipDataAttrs = { 'data-toggle': 'tooltip' };
	var randomValues = generateRandomValues(200);
	var halfYearAgo = (0, _dateHelpers.shiftDate)(new Date(), -180);
	var pastRandomValues = generateRandomValues(200, halfYearAgo);

	var githubURL = "https://github.com/patientslikeme/react-calendar-heatmap";
	var githubDemoFileURL = "https://github.com/patientslikeme/react-calendar-heatmap/blob/master/demo/demo.jsx";
	    ...
	    _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          props.example ? 'e.g. ' + props.example : null
	        )
	      ),
	      _react2.default.createElement(
	        'p',
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(_src2.default, {
	            ...
	            values: [{ date: '2016-01-01' }, { date: new Date('2016-01-02').getTime() }, { date: new Date('2016-01-03') }]
	          })
	        ),
	        _react2.default.createElement(
	          DemoItem,
